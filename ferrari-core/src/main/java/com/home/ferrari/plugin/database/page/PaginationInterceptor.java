...
import com.home.ferrari.plugin.database.dialect.Dialect;
import com.home.ferrari.plugin.database.dialect.MySqlDialect;
import com.home.ferrari.plugin.database.dialect.OracleDialect;
import com.home.ferrari.plugin.database.dialect.SqlServerDialect;
import com.home.ferrari.util.LoggerUtil;
import com.home.ferrari.util.ReflectUtil;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (page != null) {
            ...
            if(logger.isDebugEnabled()) {
                LoggerUtil.DEBUG(logger, String.format("执行SQL如下 ： %s", pageSql));
            }
